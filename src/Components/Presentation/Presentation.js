...
function Presentation(){
    return(
        <div id="Home" class="Presentation">
            <div class="titleImg">
                <img src={html} alt="HTML" className='topImg'/>
                <img src={css} alt="CSS" className='topImg'/>
                <img src={javascript} alt="JavaScript" className='topImg'/>
                ...
                <a href="https://github.com/EliasLoaiza"><img src={github} className='links' alt="gitHub"/></a>
            </div>
        </div>
    );
}
